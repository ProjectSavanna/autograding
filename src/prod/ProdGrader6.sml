functor ProdGrader6 (
  ...
  val weights : Rational.Int.int * Rational.Int.int * Rational.Int.int * Rational.Int.int * Rational.Int.int * Rational.Int.int
) :> GRADER =
  struct
    structure Rubric =
      struct
        ...
        val scores = fn {g1=g1,g2=g2,g3=g3,g4=g4,g5=g5,g6=g6} => [
        ...
        val fractions =
          let
            val (w1,w2,w3,w4,w5,w6) = weights
            val weights = [w1,w2,w3,w4,w5,w6]
        ...
        in
          val toString = fn rubric as {g1=g1,g2=g2,g3=g3,g4=g4,g5=g5,g6=g6} =>
            String.concat (
              ListPair.map format (
